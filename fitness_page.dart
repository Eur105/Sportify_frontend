...
class FitnessPage extends StatelessWidget {
  ...
  final List<FitnessSection> _sections = const [
    FitnessSection(
      sectionName: "Warm-Up",
      imagePath: "lib/assets/images/warmup.jpg",
      sectionDescription:
    ...
    FitnessSection(
      ...
      imagePath: "lib/assets/images/workout.png",
      sectionDescription:
    ...
    FitnessSection(
      ...
      imagePath: "lib/assets/images/cooldown.jpg",
      sectionDescription:
              ...
              child: Column(
                children:
                    _sections.map((section) {
                      return _buildFitnessSection(section);
                    }).toList(),
              ),
            ),
          ],
