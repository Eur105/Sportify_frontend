...
class SkillsPage extends StatelessWidget {
  ...
  final List<SportSkills> _sportsList = const [
    SportSkills(
      sportName: "Football",
      imagePath: "lib/assets/images/football_skills.jpg",
      skills: [
        Skill(
          title: "Dribbling",
    ...
    SportSkills(
      sportName: "Cricket",
      imagePath: "lib/assets/images/cricket_skills.jpg",
      skills: [
        Skill(
          title: "Batting",
    ...
    SportSkills(
      ...
      imagePath: "lib/assets/images/basketball_skills.webp",
      skills: [
        Skill(
          title: "Dribbling",
          description:
    ...
    SportSkills(
      sportName: "Badminton",
      imagePath: "lib/assets/images/badminton_skills.jpg",
      skills: [
        Skill(
          title: "Serving",
          description:
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Column(
                children:
                    _sportsList.map((sport) {
                      return _buildSportExpansion(sport);
                    }).toList(),
              ),
            ),
          ],
