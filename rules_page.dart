...
class RulesPage extends StatelessWidget {
  ...
  final List<SportRule> sports = const [
    SportRule(
      title: "Cricket",
      imagePath: "lib/assets/images/cricket.jpg",
      content: """
...
""",
    ...
    SportRule(
      title: "Basketball",
      imagePath: "lib/assets/images/basketball.jpg",
      content: """
...
""",
    ...
    SportRule(
      title: "Football",
      imagePath: "lib/assets/images/football.jpg",
      content: """
...
""",
    ...
    SportRule(
      title: "Futsal",
      imagePath: "lib/assets/images/futsal.jpg",
      content: """
...
""",
    ...
    SportRule(
      title: "Badminton",
      imagePath: "lib/assets/images/badminton.jpg",
      content: """
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children:
                sports.map((sport) {
                  return _buildSportRuleCard(sport);
                }).toList(),
          ),
        ),
      ),
